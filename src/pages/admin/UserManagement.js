...
function Modal({ user, onClose, onSave }) {
  ...
  const [form, setForm] = useState({
    ...
    role: user.role || "client", organism: user.organism || "",
    sector: user.sector || "", phone: user.phone || "",
...
.section-head{display:flex;align-items:center;gap:12px;padding:18px 24px;border-bottom:1px solid #21262d;background:#161b22;border-radius:10px 10px 0 0;}
